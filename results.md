...
Сетка значений: 1000 - 3000 - 6000 - 12000

![Разрез A: метрики vs train_size](./report_images/razrez_A.png)

Выводы: видно, что с ростом размера датасета есть рост в accuracy,precision, roc-auc, pr-auc, в recall , f1 изменение метрики очень маленькое. При этом  для большинства метрик максимум достигается при размере 6000, а не 12000, поэтому можно сделать вывод, что увеличение размера не гарантирует увеличение метрик

Лучший запуск по ROC-AUC: http://158.160.2.37:5000/#/experiments/18/runs/c5d1a68762764c75bf0a97f619833054
